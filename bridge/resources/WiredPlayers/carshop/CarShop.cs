...
namespace WiredPlayers.carshop
{
    public class CarShop : Script
    {
        ...
        private void OnResourceStartHandler()
        {
            ...
            carShopTextLabel = NAPI.TextLabel.CreateTextLabel("/catalogo", new Vector3(-56.88f, -1097.12f, 26.52f), 10.0f, 0.5f, 0, new Color(255, 255, 153));
            TextLabel carShopSubTextLabel = NAPI.TextLabel.CreateTextLabel("Escribe el comando para ver la lista de vehículos", new Vector3(-56.88f, -1097.12f, 26.42f), 10.0f, 0.5f, 0, new Color(255, 255, 255));
            ...
            motorbikeShopTextLabel = NAPI.TextLabel.CreateTextLabel("/catalogo", new Vector3(286.76f, -1148.36f, 29.29f), 10.0f, 0.5f, 0, new Color(255, 255, 153));
            TextLabel motorbikeShopSubTextLabel = NAPI.TextLabel.CreateTextLabel("Escribe el comando para ver la lista de vehículos", new Vector3(286.76f, -1148.36f, 29.19f), 10.0f, 0.5f, 0, new Color(255, 255, 255));
            ...
            shipShopTextLabel = NAPI.TextLabel.CreateTextLabel("/catalogo", new Vector3(-711.6249f, -1299.427f, 5.41f), 10.0f, 0.5f, 0, new Color(255, 255, 153));
            TextLabel shipShopSubTextLabel = NAPI.TextLabel.CreateTextLabel("Escribe el comando para ver la lista de vehículos", new Vector3(-711.6249f, -1299.427f, 5.31f), 10.0f, 0.5f, 0, new Color(255, 255, 255));
        ...
        {
            if (NAPI.Entity.GetEntityType(entity) == EntityType.Player && NAPI.Data.HasEntityData(entity, EntityData.PLAYER_DRIVING_COLSHAPE) && NAPI.Data.HasEntityData(entity, EntityData.PLAYER_TESTING_VEHICLE) == true)
            {
                ...
                {
                    NetHandle vehicle = NAPI.Data.GetEntityData(player, EntityData.PLAYER_TESTING_VEHICLE);
